...
public class WebViewDocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.webview_doc_excel_layout);
        initDatas();
        initPaths();
        ...
        mRecyclerView.setAdapter(new RecyclerView.Adapter() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                return new RecyclerView.ViewHolder(LayoutInflater.from(WebViewDocActivity.this).inflate(R.layout.item, parent, false)) {
                };
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
                holder.itemView.findViewById(R.id.item_root).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!EasyPermissions.hasPermissions(WebViewDocActivity.this, perms)) {
                            EasyPermissions.requestPermissions(WebViewDocActivity.this, "需要访问手机存储权限！", 10086, perms);
                        } else {
                            FileDisplayActivity.show(WebViewDocActivity.this, filePath);
                        }
                    }
                });
    ...
    private String getFilePath(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                path = "https://ysoa.qiban.com/img/2018/05/21_13/导入模板的副本.xlsx";
                break;
            case 2:
                //path = "/storage/emulated/0/test.txt";
                path = "https://ysoa.qiban.com/img/2018/05/17_14/测试上传Word 文档.docx";
                break;
            case 3:
            ...
            case 5:
                ...
                path = "img/2018/05/17_14/测试上传Word 文档.docx";
                break;
        }
        return path;
    }
